...
export function postListTitle(post: { title: string; titleEn: string | null }, locale: SiteLocale): string {
...
export function featuredListTitle(post: { title: string; titleEn: string | null }, locale: SiteLocale): string {
